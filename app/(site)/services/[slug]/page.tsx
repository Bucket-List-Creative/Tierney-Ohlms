          ...
          <div className="container-x py-20 max-[767px]:py-14">
            <Reveal variant="up" duration={850}>
              <div className="grid items-center gap-10 min-[981px]:grid-cols-[1fr_auto]">
                <div>
                  <span className="font-mono text-[11px] max-[1199px]:text-[12px] uppercase tracking-[.14em] text-gold">
                    What you get
                  </span>
  ...
  return (
    <article className="relative z-[1] flex flex-col gap-5 rounded-panel border border-rule bg-white p-8 shadow-[0_24px_48px_rgba(17,17,17,0.09)] max-[560px]:p-7">
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="font-mono text-[10px] max-[1199px]:text-[12px] uppercase tracking-[.14em] text-brass">
          {step} / {total}
        </span>
      </div>
      ...
      <div className="flex flex-col">
        {rows.map(([label, value]) => (
          ...
          >
            <span className="font-mono text-[10px] max-[1199px]:text-[12px] uppercase tracking-[.12em] text-dark-label">
              {label}
            </span>
